...
export default class Switch extends React.Component<SwitchProps> {
  ...
  render(): React.ReactNode {
    const {onChange, style, disabled, value, activeStyle, inActiveStyle,dotStyle} = this.props;
    const containerStyle = [
      styles.wrapper,
      style,
      disabled ? styles.disabled : null,
      value ? (activeStyle ? activeStyle : styles.right) : inActiveStyle ? inActiveStyle : styles.left,
    ];
    const dotStyles = [
      styles.dot, dotStyle,
